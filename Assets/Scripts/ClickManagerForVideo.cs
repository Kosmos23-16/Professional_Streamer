...
public class ClickManagerForVideo : MonoBehaviour
{
    ...
    [Header("Text`s")] public Text likesText;
    ...
    public void ButtonClick()
    {
        ...
        if (likesToNextFollower >= 50)
        {
            int newFollowers = likesToNextFollower / 50;
            likesToNextFollower %= 50;
